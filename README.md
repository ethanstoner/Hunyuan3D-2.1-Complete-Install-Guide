...
> ⚠️ **Important**: This guide is specifically validated for:
...
> ⚠️ **Critical**: Do **not** mix ComfyUI versions. All steps are validated against **v0.3.45** only.
...
#### 1.3 KJNodes (⚠️ Version-Specific)

> ⚠️ **Critical**: This workflow requires KJNodes, but newer versions are incompatible due to `comfy_api.latest` changes.
...
> ⚠️ **Critical**: All installations **must** use ComfyUI's embedded Python.
...
> ⚠️ **Do not** update KJNodes after fixing this.
...
- ⚠️ **Avoid auto-updating custom nodes** (especially KJNodes)
- ⚠️ **Do not use "Update all" in ComfyUI-Manager**
